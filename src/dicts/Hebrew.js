const DICT = {
    ...
    ch_video: 'l5UJygozbxQ',
    kids4_5_exvideo: 'ee02yf3e6pE',
    white_orange_exvideo: 'F5FeUY16PRM',
    blue_exvideo: 'F5FeUY16PRM',
    yellow_exvideo: 'S2dCGPJ2qnc',
    green_exvideo: '1xES8mGhmRo',

    end_date: Date.parse('2020-04-01 23:59:59')
